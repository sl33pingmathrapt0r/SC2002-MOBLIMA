...
public class PriceTable {
    ...
    public static void initPriceTable() {
        ...
        publicHolidays=new ArrayList<Date>();
        readFile();
        loadPH();
    }
    ...
    /**
     * Change price of a ticket given date object
    ...
    public static boolean isPH(Date date) {
        for(Date PH : publicHolidays){
            String d1 = new SimpleDateFormat("ddMM").format(date);
            String d2 = new SimpleDateFormat("ddMM").format(PH);
        ...
        while(true){
            ...
            if(publicHolidays.size()!=0){
                for(Date d : publicHolidays){
                    System.out.println(new SimpleDateFormat("dd MMM").format(d));
                }
            }
            else{
