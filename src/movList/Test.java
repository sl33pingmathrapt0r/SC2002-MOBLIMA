...
public class Test {
	...
	public static void main(String[] args)
	{
		...
		for(Movie mov : MovieList.getMovieList()){
			System.out.println(mov.toString());
			System.out.println();
		}
		System.out.println();
		try{
			Movie[] movAr = MovieList.getMovieList().toArray(new Movie[MovieList.getMovieList().size()]);
			for(Movie mov : MovieList.sortBySales(movAr)){
				System.out.println(mov.getSales());
			}
		...
		// 	System.out.println("12 sortByRating");
		// 	System.out.println("13 sortBySales");
		// 	System.out.println("14 getCwd");
		// 	int n = sc.nextInt();
		// }
		// for(Movie mov : MovieList.getMovieList()) System.out.println(mov.getTitle());
