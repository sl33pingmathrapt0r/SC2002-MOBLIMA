...
public class Ticket {
	...
	public Ticket(String movieTitle, TypeOfMovie typeOfMovie, ClassOfCinema classOfCinema, String clientName,
		...
		this.seatID = seatID;
		this.price = Ticket.calculatePrice(this.classOfCinema, this.typeOfMovie, this.ageGroup, this.dayOfWeek,
				this.timeOfMovie);
	 ...
	 */
	private static double calculatePrice(ClassOfCinema classOfCinema, TypeOfMovie typeOfMovie, AgeGroup ageGroup,
				...
				case THURSDAY:
					...
					if (ageGroup == AgeGroup.STUDENT && timeOfMovie[0] < 18) {
						...
						// regular and digital are $1 cheaper than blockbuster
							...
							if (typeOfMovie == TypeOfMovie.BLOCKBUSTER)
								return 8.00;
							else
								return 7.00;
						}
					...
					// senior citizen
					if (ageGroup == AgeGroup.SENIOR && timeOfMovie[0] < 18 && classOfCinema == ClassOfCinema.REGULAR)
						return 5.00;
					// adult
					if (typeOfMovie == TypeOfMovie.D3)
						return 12.00;
